...
difference(){
	cylinder(r=attachment_od/2, h=length);
	translate([0,0,-0.1])
	cylinder(r=bayonet_od/2, h=length+2);
	for(i=[0:2]){
		rotate([0,0,120*i]){
			translate([0,0,-0.1]){
				intersection(){
