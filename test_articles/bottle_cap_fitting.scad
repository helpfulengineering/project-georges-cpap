...
difference() {
    union() {
        ...
        cylinder(12, d=32);
        translate([0, 7, 4]) rotate([270,0,0]) barb(6.35, 25, clearance=15, wall=1.1, barb=0.5);
        translate([0, -7, 5.5]) rotate([90,0,0]) barb(6.35, 25, clearance=15, wall=1.1, barb=0.5);
    ...
    translate([0,8,5.4]) cylinder(9, d1=3.5, d2=6);
    translate([0,6,4]) rotate([270,0,0]) cylinder(10, d=4.1);

    translate([0,-16,5.9]) rotate([270,0,0]) cylinder(14, d=4.1);
    translate([0,-4.7,5.99]) cylinder(8, d=5);
